...
- April 24, 2025
- fix bug in
  [`stackAssays()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/stackAssays.md)
...
- Oct 27, 2024
- Better error reporting addressing
  <https://github.com/GabrielHoffman/dreamlet/issues/25>
...
- [`dreamlet()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/dreamlet.md)
  gives clearer error message for singular design matrix
- [`plotGeneHeatmap()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotGeneHeatmap-methods.md)
  handles `zmax` correctly now
...
- bug fix in
  [`compositePosteriorTest()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/compositePosteriorTest.md)
...
- new functionality in
  [`plotPCA()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotPCA.md)
  and
...
- in
  ...
  pass argument `scaledByLib` to `voomWithDreamWeights()`
...
- update
  ...
  to compute z-scores. How returns
...
- Jan 16, 2024
- [`compositePosteriorTest()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/compositePosteriorTest.md)
  allows `exclude` set to be `NULL`

## dreamlet 1.1.11

- Jan 16, 2024
- add
  [`meta_analysis()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/meta_analysis.md)

## dreamlet 1.1.10

- Jan 10, 2024
- [`stackAssays()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/stackAssays.md)
  now includeds `metadata()$aggr_means` correctly
- add
  [`compositePosteriorTest()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/compositePosteriorTest.md)
...
- Dec 10, 2023
- add
  [`plotBeeswarm()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotBeeswarm.md)
- add `rowWeightedVarsMatrix()`
- bug fixes
- add `isFullRank()` check in
  [`dreamlet()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/dreamlet.md)
...
- Nov 13, 2023
- [`computeLogCPM()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/computeLogCPM.md)
...
- [`computeLogCPM()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/computeLogCPM.md)
  now returns `matrix` instead of `sparseMatrix`
...
- Include `setAutoBlockSize()` update within
  [`aggregateToPseudoBulk()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/aggregateToPseudoBulk.md)
...
- [`dreamletCompareClusters()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/dreamletCompareClusters.md)
  now allows cell-level covariates in response to
  <https://github.com/GabrielHoffman/dreamlet/issues/11>
...
- Improve functionality and documentation of
  [`dreamlet::residuals()`](https://rdrr.io/r/stats/residuals.html)
...
- in
  [`processAssays()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/processAssays.md)
  use `voomWithDreamWeights(..., span="auto")` to estimate the lowess
  tuning parameter
- rare error in `merge_metadata()` when a cell type is not observed for
  all donors.
...
- June 27, 2023
- add `assays` argument to
  [`buildClusterTreeFromPB()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/buildClusterTreeFromPB.md)
...
- March 29, 2023
- fix [`topTable()`](https://rdrr.io/pkg/limma/man/toptable.html) for
  `dreamletResult` in the case where one or more cells didn’t estimate
...
- add
  [`computeNormCounts()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/computeNormCounts.md)
  and
  [`computeLogCPM()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/computeLogCPM.md)
...
- March 7, 2023
- fix [`topTable()`](https://rdrr.io/pkg/limma/man/toptable.html) to
  deal with multiple `coef` as array
...
- small bug fixes in
  ...
  [`plotForest()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotForest-methods.md)
...
- Use these covariates in
  ...
  [`fitVarPart()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/fitVarPart.md)
- extend to
  [`aggregateNonCountSignal()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/aggregateNonCountSignal.md)

## dreamlet 0.0.61

- Jan 25, 2023
- add
  [`plotProjection()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotProjection.md)
- add
  [`outlier()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/outlier.md)
- update
  [`plotForest()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotForest-methods.md)
...
- Jan 12, 2023
- update
  [`plotVolcano()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotVolcano-methods.md)
...
- Jan 9, 2023
- Rewrite[`aggregateNonCountSignal()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/aggregateNonCountSignal.md)
  to include filters
...
- Nov 18, 2022
- fix bug in [`topTable()`](https://rdrr.io/pkg/limma/man/toptable.html)

## dreamlet 0.0.52

- Nov 18, 2022
- add
  [`as.dreamletResult()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/as.dreamletResult.md)
...
- in
  [`processAssays()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/processAssays.md)
  and
  [`processOneAssay()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/processOneAssay.md),
  add argument `min.prop` indicating the minimum proportion of retained
  samples with non-zero counts

## dreamlet 0.0.50

- Nov 2, 2022
- fix bug in
  [`zenith_gsa()`](http://gabrielhoffman.github.io/zenith/reference/zenith_gsa-methods.md)
  for few gene sets
...
- add `transpose` argument to
  [`plotGeneHeatmap()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotGeneHeatmap-methods.md)
- and `alpha` arugment to
  [`plotVoom()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotVoom-methods.md)
...
- add `totalCPM` column to output of
  [`cellTypeSpecificity()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/cellTypeSpecificity.md)
  to use for filtering. Functions
  [`dreamlet::plotHeatmap()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotHeatmap-methods.md)
  [`plotViolin()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotViolin-methods.md)
  and `plotPercentBars()` now ignore this column
...
- more flexibility for
  [`tabToMatrix()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/tabToMatrix.md)
...
- fix issue with
  [`topTable()`](https://rdrr.io/pkg/limma/man/toptable.html) when all
  random effects are dropped
...
- [`aggregateToPseudoBulk()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/aggregateToPseudoBulk.md)
  for `DelayedArray` now uses `colsum_fast()`
...
- update
  [`dreamletCompareClusters()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/dreamletCompareClusters.md):
  - now compatable with
    [`plotZenithResults()`](http://gabrielhoffman.github.io/zenith/reference/plotZenithResults.md)
...
- fix bug in
  [`cellTypeSpecificity()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/cellTypeSpecificity.md)
  for genes with zero reads across all cell types
...
- expand vignettes
- bug fix for
  [`removeConstantTerms()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/removeConstantTerms.md)
  when excluded variable string (i.e. tissue) is also a substring of
  other variables (i.e. tissueStatus)

## dreamlet 0.0.16

- add [`residuals()`](https://rdrr.io/r/stats/residuals.html) for
  [`dreamlet()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/dreamlet.md)
  result
- add `dreamletPairs()`
- fix bug in
  [`removeConstantTerms()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/removeConstantTerms.md)
  with multiple constant terms
- improve usability of
  [`cellTypeSpecificity()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/cellTypeSpecificity.md)
  by adding `plotPercentBars()` and
  [`plotViolin()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/plotViolin-methods.md)
  compatability
- fix bug in [`topTable()`](https://rdrr.io/pkg/limma/man/toptable.html)
  when `coef` is not estimated
- add argument `assays` to
  [`dreamlet()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/dreamlet.md),
  [`fitVarPart()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/fitVarPart.md),
  and
  [`processAssays()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/processAssays.md)
...
- Oct 15, 2021
- update print for `dreamletResult` using
  [`coefNames()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/coefNames-methods.md)
- small bug fix
...
- [`removeConstantTerms()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/removeConstantTerms.md)
  ...
  - this means that other functions can gracefully warn the user about
    NA’s
...
- call to
  [`zenith_gsa()`](http://gabrielhoffman.github.io/zenith/reference/zenith_gsa-methods.md)
  adds argument `inter.gene.cor` and `progressbar`

- fix output to `cellTypeCompositionVarPart()` and
  `cellTypeCompositionTest()`

- fix issue with
  [`topTable()`](https://rdrr.io/pkg/limma/man/toptable.html) where FDR
  was evaluated on only a subset of genes
...
- update
  [`dreamlet()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/dreamlet.md)
  to handle linear contrasts
- [`removeConstantTerms()`](http://DiseaseNeurogenomics.github.io/dreamlet/reference/removeConstantTerms.md)
  now drops categorical variables with only a max of one example per
  category
...
- add details() functions for dreamletResult, dreamletProcessedData and
  vpDF
